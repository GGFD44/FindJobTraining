...
<head>
	...
	<title>FindJobTraining - Contact Us</title>
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><h3 style="font-family:Arial; color: #f1f1f1;">FindJobTraining</h3></a>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Kedah, <br/> Sungai Petani, <br/>Kolej Vokasional Sungai Petani 1</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:muhammad116079@yes.my">muhammad116079@yes.my</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+60 10 805 0179">+60 10 805 0179</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About FindJobTraining</h5>
											<p>FindJobTraining is a OJT [OnJobTraining] Portal, that can use for students from Kolej Vokasional Sungai Petani 1 in the final year of the diploma to find an industrial training place..</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">FindJobTraining Contact</h5>
								
								<p>Address : Kedah, Kolej Vokasional Sungai Petani 1</p>
								<p>Email : <a href="mailto:muhammad116079@yes.my">muhammad116079@yes.my</a></p>
								<p>Phone : <a href="tel:+60 10 805 0179">+60 10 805 0179</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> FindJobTraining Vision</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Faris Daneal</a></li>
								</ul>
